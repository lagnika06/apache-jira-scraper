...
Save raw responses in data/raw/
...
✅ Logging & Error Handling – Retry logic, clean logs, graceful failures
✅ Modular Codebase – Separate layers for scraping, transforming, and utils
✅ Version Control Ready – .gitignore and .gitkeep for clean commits
...
Copy code
        ...
        └─────────┬────────────────┘
                  ...
                  ▼
        ┌──────────────────────────┐
        │ data/processed/*.jsonl   │ → Ready for analytics / LLMs
        └──────────────────────────┘
⚠️ Data Notes
📌 The data/raw and data/processed folders are excluded from GitHub to avoid large file uploads (> 25 MB).
Empty directories are preserved using .gitkeep files and will be populated when the scraper runs.
